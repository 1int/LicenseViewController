...
Pod::Spec.new do |s|
  ...
  s.name         = "LicenseViewController"
  s.version      = "1.0"
  s.summary      = "A zero configuration view controller to display license & other user agreements"

  s.description  = <<-DESC
                        Just include the header and write [myViewController showLicense];
                        That will present the license controller with the contents of 'license.md' file from main bundle.
                        Also, for showing license on first launch only use [myViewController showLicenseAtFirstLaunch];
...
#s.dependency "AttributedMarkdown", :git => "https://github.com/dreamwieber/AttributedMarkdown.git"
